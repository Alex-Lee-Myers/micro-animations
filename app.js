...
//! START: [Home] animation on click
gsap.set(".feather", {scale:0, transformOrigin: 'center'}); //* Make feather invisible by default before click. Scale up from middle point of SVG with transformOrigin: center.
home.addEventListener('click', () => {
    ...
    gsap.fromTo('.right-feather', {x:0}, {x: 5}) //* right feather starts at 0, moves to x-axis 5 when dropping with .feather
})
//! END: [Home] animation on click

//* ______________________________

//! START: [Bell] animation on click
//* Default starting point for SVG sections aka transformOrigin.
...
//! END: [Bell] animation on click

//! START: [Messages] animation on click
